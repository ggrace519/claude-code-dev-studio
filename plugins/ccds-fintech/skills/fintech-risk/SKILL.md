...
You do NOT own:
- KYC / AML rule-based compliance → `fintech-compliance`
- Ledger entries and balances → `fintech-ledger`
- Audit logging of decisions → `fintech-audit-trail`
