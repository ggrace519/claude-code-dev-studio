...
- Universal UI component design → `ux-design` (collaborate)
- Engine-specific input API → `game-engine`
...
- **Recommended next steps** — Return findings to the orchestrator; `pr-code-reviewer` reviews implementation before proceeding. If accessibility coverage is insufficient, invoke `common-a11y`.
