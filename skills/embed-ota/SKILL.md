...
- RTOS task scheduling → `embed-rtos`
- Driver for the transport peripheral → `embed-driver`
- Power budget of the update window → `embed-power`
